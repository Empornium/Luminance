        ...
        if ($tokens[$objOperator]['code'] === T_OBJECT_OPERATOR) {
            ...
            if ($tokens[$var]['code'] === T_STRING) {
                ...
                if ($tokens[$bracket]['code'] !== T_OPEN_PARENTHESIS) {
                    ...
                    # Object properties can use Pascal Case (DB rows) or Snake Case (settings)
                    # These properties are created programatically and never explicitly declared
                    # explicitly declared properties must use correct Camel Case and are checked
                    # later in this sniff.
                    if (preg_match("/^([a-zA-Z0-9]|[a-z0-9_])/", $objVarName) === 0) {
    ...
    protected function processMemberVar(File $phpcsFile, $stackPtr)
    {
        ...
        if ($public === true) {
            if (substr($varName, 0, 1) === '_') {
                ...
                $phpcsFile->addError($error, $stackPtr, 'StartsUnderscore', $data);
            }
        }
