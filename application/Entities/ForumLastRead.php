...
/**
 * ForumLastRead Entity representing rows from the `forums_last_read_threads` DB table.
 */
class ForumLastRead extends Entity {
     ...
     * @static
     */
    public static $table = 'forums_last_read_threads';
    ...
    public static $properties = [
        'ThreadID' => [ 'type' => 'int', 'sqltype' => 'INT UNSIGNED', 'primary' => true, 'nullable' => false ],
        'UserID'   => [ 'type' => 'int', 'sqltype' => 'INT UNSIGNED', 'primary' => true, 'nullable' => false ],
        'PostID'   => [ 'type' => 'int', 'sqltype' => 'INT UNSIGNED', 'nullable' => false ],
    ];
        ...
        switch ($name) {
            case 'post':
                if (!array_key_exists($name, $this->localValues)) {
                    $this->safeSet($name, $this->repos->forumPosts->load($this->PostID));
                }
                break;
        }
