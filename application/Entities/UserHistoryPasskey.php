...
/**
 * UserHistoryPasskey Entity representing rows from the `users_history_passkeys` DB table.
 */
class UserHistoryPasskey extends Entity {
     ...
     * @static
     */
    public static $table = 'users_history_passkeys';
    ...
    public static $properties = [
        ...
        'OldPassKey'  => [ 'type' => 'str', 'sqltype' => 'VARCHAR(32)', 'default' => null, 'nullable' => true ],
        'NewPassKey'  => [ 'type' => 'str', 'sqltype' => 'VARCHAR(32)', 'default' => null, 'nullable' => true ],
    ];
