...
require(SERVER_ROOT.'/sections/blog/functions.php');
...
if (!empty($_REQUEST['action'])) {
    ...
    switch ($_REQUEST['action']) {
        ...
        case 'editpost':
        case 'newpost':
            require(SERVER_ROOT.'/sections/blog/editnew.php');
            break;
        ...
        case 'takeeditpost':
            authorize();
            require(SERVER_ROOT.'/sections/blog/takeedit.php');
            break;

        case 'takenewpost':
            authorize();
            require(SERVER_ROOT.'/sections/blog/takenew.php');
            break;

        default:
            require(SERVER_ROOT.'/sections/blog/blog.php');
            break;
    }
} else {
    // view the section
