...
if ($ConvID = (int) $_GET['id']) {
    ...
    //$UserInfo = $OwnerInfo;
    $UserStr = format_username($TargetUserID, $OwnerInfo['Username'], $OwnerInfo['Donor'], $OwnerInfo['Warned'], $OwnerInfo['Enabled'], $OwnerInfo['PermissionID'], $OwnerInfo['Title'], true, $OwnerInfo['GroupPermissionID'], $IsFLS);
      //$OwnerID = $UserID;
    if ($ResolverID) {
