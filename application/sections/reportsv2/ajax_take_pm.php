...
if ($Recipient == 'Uploader') {
    ...
    if ($Report) {
        $Message = "You uploaded [url=http://".SITE_URL."/torrents.php?torrentid=".$TorrentID."]the above torrent[/url], it has been reported for the reason: ".$ReportType['title']."\n\n".$Message;
    } else {
        $Message = "I am PMing you as you are the uploader of [url=http://".SITE_URL."/torrents.php?torrentid=".$TorrentID."]the above torrent[/url].\n\n".$Message;
    }
