...
<?php                           } ?>
                    ...
                    <td class="center">
                          <input type="checkbox" name="sendpm[<?=$ID?>]" value="1" <?=($SendPM?'checked="checked"':'')?> onchange="Set_Edit('<?=$ID?>')" title="If checked then the user is sent a PM telling them when they receive this award" />
                    </td>
                    <td class="center">
