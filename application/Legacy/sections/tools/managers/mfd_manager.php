...
<?php       }   ?>
            ...
            <table>
                <tr class="colhead">
<?php  if ($NumOverdue && $CanManage) {
?><td width="8px"><input type="checkbox" onclick="toggleChecks('reviewform',this)" /></td><?php
} ?>
                    <td>Torrent</td>
...
<?php  }
if ($NumOverdue && $CanManage && $ViewStatus != 'unmarked') {
?><td class="center"><?=$IsOverdue?'<input type="checkbox" name="id[]" value="'.$GroupID.'" />':''?></td><?php
} ?>
