...
<?php  } if (check_perms('admin_login_watch')) { ?>
            <tr><td><a href="/tools.php?action=security_logs">Security Logs</a></td></tr>
<?php  } if (check_perms('admin_login_watch')) { ?>
            <tr><td><a href="/tools.php?action=disabled_hits">Disabled Hits</a></td></tr>
...
<?php  } if (check_perms('users_fls')) { ?>
            <tr><td><a href="/collages.php?action=allcomments">Recent Collage Comments</a></td></tr>
<?php  } if (check_perms('users_fls')) { ?>
            <tr><td><a href="/forums.php?action=allposts">Recent Forum Posts</a></td></tr>
