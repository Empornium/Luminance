    ...
    <tr class="smallhead">
        <td colspan="2">
            <span style="float:left;"><a class="post_id" href="/collages.php?id=<?=$CollageID?>&amp;postid=<?=$PostID?>#post<?=$PostID?>">#<?=$PostID?></a>
                <?=format_username($AuthorID, $Username, $Donor, true, $Enabled, $PermissionID, $UserTitle, true)?> <?=time_diff($AddedTime)?> <a href="/reports.php?action=report&amp;type=collages_comment&amp;id=<?=$PostID?>">[Report]</a>
