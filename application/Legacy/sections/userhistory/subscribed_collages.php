...
show_header('Subscribed collages', 'browse,collage,overlib');
    ...
    if (!$NumResults) {
        ...
        foreach ($CollageSubs as $Collage) {
            ...
            foreach ($TorrentList as $GroupID => $Group) {
                ...
                $DisplayName = '<a href="/torrents.php?id=' . $GroupID . '" onmouseover="return overlib(overlay'.$GroupID.', FULLHTML);" onmouseout="return nd();">' . display_str($GroupName) . '</a>';
                ...
                <tr class="torrent" id="group_<?= $CollageID ?><?= $GroupID ?>">
                    ...
                    <td>
                        <?php if (!$LoggedUser['HideFloat']) {
                            ...
                            $Overlay = get_overlay_html($GroupName, $TorrentUsername, $Image, $Torrent['Seeders'], $Torrent['Leechers'], $Torrent['Size'], $Torrent['Snatched']); ?>
                            <script>
