...
include(SERVER_ROOT.'/Legacy/sections/torrents/functions.php'); // Edit report etc.
...
<?php               if (!$ViewingOwn) { ?>
                        by <?=format_username($UserID, $Username, $Donor, true, $Enabled, $Class, false, true, $GroupPermID)?>
<?php               } ?>
                    <?=time_diff($AddedTime) ?>
