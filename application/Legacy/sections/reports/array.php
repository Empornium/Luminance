...
$types = [
    "user" => [
        "title" => "User",
        "guidelines" => [
            "The Report User option is for reporting a user who has broken one of the golden rules outlined <a href=\"/articles/view/rules\">here</a>, or if you need to alert staff to something specific about a user that cannot be reported elsewhere.",
    ...
    "collage" => [
        "title" => "Collage",
        "guidelines" => [
            "The report collage option is for reporting a collage which breaks one of the collage guidelines found on the <a href=\"/articles/view/collages\">collage rules page</a>.",
