...
$isStaffPmRestricted = $master->repos->restrictions->is_restricted($LoggedUser['ID'], Luminance\Entities\Restriction::STAFFPM);

// No need to display an empty page if they have no rights at all
if (!check_perms('site_staff_page') && $isStaffPmRestricted) {
    error(403);
}
