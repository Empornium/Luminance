    ...
    <tr class="smallhead">
        <td colspan="2">
            <span style="float:left;"><a class="post_id" href="/requests.php?action=view&amp;id=<?=$RequestID?>&amp;postid=<?=$PostID?>#post<?=$PostID?>">#<?=$PostID?></a>
                <?=format_username($AuthorID, $Username, $Donor, true, $Enabled, $PermissionID, $UserTitle, true)?> <?=time_diff($AddedTime)?> <a href="/reports.php?action=report&amp;type=requests_comment&amp;id=<?=$PostID?>">[Report]</a>
