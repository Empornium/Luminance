<?php
namespace Luminance\Legacy\sections\reportsv2;
    ...
    public static function getTypes() {
        return [
            ...
            'banned' => [
                ...
                'article' => ['forbiddencontent', "Forbidden Content (Do Not Upload list)"]
            ],
            'urgent' => [
                'priority' => '28',
                'title' => 'Urgent',
            ...
            'screens' => [
                ...
                'article' => ['screenrules', "Screenshot Rules"]
            ],
            'description' => [
                'priority' => '8',
                ...
                'article' => ['descrules', "Description Rules"]
            ],
            'pack' => [
                'priority' => '2',
                ...
                'article' => ['ziprules', "Compressed Files Rules"]
            ],
            'virus' => [
                'priority' => '6',
