...
{
    global $master;
    if (check_forumperm($ForumID, 'Write') && check_forumperm($ForumID, 'Create') && !$master->repos->restrictions->is_restricted($LoggedUser['ID'], Luminance\Entities\Restriction::POST)) { ?>
