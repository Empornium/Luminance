...
if (!$WHERE1 && !$WHERE2 && $Page==1) { // lets cache front page results for a few hours
    ...
    // get the syns for the tag results
            ...
            foreach ($Tags as $tID => $TagInfo) {
                if (isset($Syns[$tID])) {
                    $Tags[$tID] = array_merge($Syns[$tID], $TagInfo);
                }
            }
        }
        ...
        <table class="box pad ">
            <form method="get" action="tags.php">
                <tr class="">
                    ...
                    <td class="nobr">
                        <input name="search_type" value="tags" type="radio" <?php if ($_GET['search_type']=='tags') {
                            echo 'checked="checked"';
                                                                            }?> />Tags &nbsp;&nbsp;
                        <input name="search_type" value="syns" type="radio" <?php if ($_GET['search_type']=='syns') {
                            echo 'checked="checked"';
                                                                            }?> />Synonyms &nbsp;&nbsp;
                        <input name="search_type" value="both" type="radio" <?php if (!isset($_GET['search_type']) || $_GET['search_type']=='both') {
                            echo 'checked="checked"';
                                                                            }?> />Both &nbsp;&nbsp;
