...
--
-- Table structure for table `client_accepts`
--

/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE IF NOT EXISTS `client_accepts` (
  `ID` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `Accept` varchar(255) DEFAULT NULL,
  `AcceptCharset` varchar(255) DEFAULT NULL,
  `AcceptEncoding` varchar(255) DEFAULT NULL,
  `AcceptLanguage` varchar(255) DEFAULT NULL,
  PRIMARY KEY (`ID`),
  KEY `Accept` (`Accept`),
  KEY `AcceptCharset` (`AcceptCharset`),
  KEY `AcceptEncoding` (`AcceptEncoding`),
  KEY `AcceptLanguage` (`AcceptLanguage`)
